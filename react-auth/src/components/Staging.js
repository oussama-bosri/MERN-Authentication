                                ...
                                <div class="container-fluid px-4">
                                    <div class="container-fluid">
                                      ...
                                      <h1 class="my-2"><Clock/></h1>
                                        <div class="col-sm-6">
                                                ...
                                                <div class="card mb-4">
                                                    <div class="card-header">
                                                       <h5><i class="fas fa-chart-bar me-1"></i>CRL Information</h5> 
                                                    </div>
                                                    <Crl/>
                                                    <Hash/>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                        <div class="card-header">
                                          <h5><i class="fas fa-chart-area me-1"></i>AECE STG OCSP Monitor</h5>
                                          </div>
                                          <div class="card-body" style={{ overflowY: 'scroll', height: '235px' }}>
                                            <Stgocsp/>
                                            </div>
                                        </div>
                                      </div>
